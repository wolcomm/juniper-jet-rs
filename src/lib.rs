...
//!
//! The `protoc` command line tool (included in the `protobuf` package on most Linux distributions)
...
//!
//! Support for each `major.minor` Junos version is enabled by a corresponding
//! `junos-{major}-{minor}` cargo feature.
//!
...
//!
//! ``` no_run
#![doc = include_str!("../examples/demo-op-cmd.rs")]
//! ```
//!
